A distribution that represents the probability of x events occuring in a given time frame if the events have a constant mean rate and are independent of the time since the last event
```R Commander
